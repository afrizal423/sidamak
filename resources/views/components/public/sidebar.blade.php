<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #b8b7b7;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="form-inline my-2 my-lg-0 text-white">
        <a href="{{ route('login') }}" class="btn btn-m btn-outline-secondary text-white">Login Admin</a>
        {{-- <button class="btn btn-m btn-outline-secondary text-white" type="button">Login Admin</button> --}}
      </div>
    </div>
  </nav>
